...
data = pd.read_csv('Goa_lat_lon.csv', na_values=['NA', 'NaN', 'N/A', 'nan', ''])
...
custom_colors = ['#FF5733', '#FFBD33', '#33FF57', '#339CFF', '#FF33C7']
...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.Img(src=app.get_asset_url('Goa_district.png'),
                     style={'width': '500px', 'height': '600px', 'display': 'inline-block', 'margin-right': '50px',
        ...
        html.Div([
            ...
            html.H1('Goa Rainfall', style={'text-align': 'center', 'margin-top': '10px'}),
